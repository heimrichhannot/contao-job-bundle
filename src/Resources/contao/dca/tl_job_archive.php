...
$GLOBALS['TL_DCA']['tl_job_archive'] = [
    'config'   => [
        ...
        'onload_callback'   => [
            ['huh.job.data_container.job_archive', 'checkPermission'],
        ],
        'onsubmit_callback' => [
    ...
    'list'     => [
        ...
        'operations'        => [
            ...
            'editheader' => [
                ...
                'href'            => 'act=edit',
                'icon'            => 'header.gif',
                'button_callback' => ['huh.job.data_container.job_archive', 'editHeader']
            ],
            'copy'       => [
                'label'           => &$GLOBALS['TL_LANG']['tl_job_archive']['copy'],
                'href'            => 'act=copy',
                'icon'            => 'copy.gif',
                'button_callback' => ['huh.job.data_container.job_archive', 'copyArchive']
            ],
            'delete'     => [
                'label'           => &$GLOBALS['TL_LANG']['tl_job_archive']['copy'],
                'href'            => 'act=delete',
                ...
                'button_callback' => ['huh.job.data_container.job_archive', 'deleteArchive']
            ],
            'show'       => [
